...
function CheckInModal({ isOpen, onClose, location, onConfirm }) {
  const { user } = useAuth();
  console.log('CheckInModal rendered, isOpen:', isOpen, 'location:', location, 'user:', user);
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      console.error('Error in check-in request:', err);
